...
public static class PermissionDatabase {
    ...
    public static readonly IReadOnlyDictionary<string, HashSet<CommandPermission>> CommandPermissionMap = new Dictionary<string, HashSet<CommandPermission>>
        {
            // AchievementsManager
            { "AchievementsManager.InvokeUserCode_CmdAddAchievementPoint__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General, CommandPermission.Restocker } },
            { "AchievementsManager.InvokeUserCode_CmdMaxFundsCheckouted__Single", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            // CardboardBaler
            { "CardboardBaler.InvokeUserCode_CmdAddBoxToBaler", new HashSet<CommandPermission> { CommandPermission.General } },

            // Data_Container
            { "Data_Container.InvokeUserCode_CmdUpdateArrayValues__Int32__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "Data_Container.InvokeUserCode_CmdContainerClear__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "Data_Container.InvokeUserCode_CmdUpdateArrayValuesStorage__Int32__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "Data_Container.InvokeUserCode_CmdActivateCashMethod__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "Data_Container.InvokeUserCode_CmdActivateCreditCardMethod", new HashSet<CommandPermission> { CommandPermission.General } },
            { "Data_Container.InvokeUserCode_CmdReceivePayment__Single", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "DebtManager.InvokeUserCode_CmdRequestLoan__Int32__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            // GameData
            { "GameData.InvokeUserCode_CmdAlterFunds__Single", new HashSet<CommandPermission> { CommandPermission.Manager } },
            { "GameData.InvokeUserCode_CmdAlterFundsWithoutExperience__Single", new HashSet<CommandPermission> { CommandPermission.General } },
            { "GameData.InvokeUserCode_CmdAcquireFranchise__Int32", new HashSet<CommandPermission> { CommandPermission.Manager } },
            { "GameData.InvokeUserCode_CmdOpenSupermarket", new HashSet<CommandPermission> { CommandPermission.General } },
            { "GameData.InvokeUserCode_CmdEndDayFromButton", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "ManagerBlackboard.InvokeUserCode_CmdSpawnBoxFromPlayer__Vector3__Int32__Int32__Single", new HashSet<CommandPermission> { CommandPermission.General } },

            // MiniTransportBehaviour
            { "MiniTransportBehaviour.InvokeUserCode_CmdRequestOwnership__GameObject", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "MiniTransportBehaviour.InvokeUserCode_CmdCollisionHit__Vector3__Single", new HashSet<CommandPermission> { CommandPermission.General } },
            { "MiniTransportBehaviour.InvokeUserCode_CmdHorn", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            // NetworkSpawner
            { "NetworkSpawner.InvokeUserCode_CmdSpawn__Int32__Vector3__Vector3", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "NetworkSpawner.InvokeUserCode_CmdObjectMove__GameObject__Vector3__Quaternion", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "NetworkSpawner.InvokeUserCode_CmdDestroyBox__GameObject", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "PlayerNetwork.InvokeUserCode_CmdSetBoxColorToEveryone__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "PlayerNetwork.InvokeUserCode_CmdUpdateTrayToEveryone__String", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "PlayerNetwork.InvokeUserCode_CmdChangeEquippedItem__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "PlayerNetwork.InvokeUserCode_CmdPlayAnimation__Int32", new HashSet<CommandPermission> { CommandPermission.Manager } },
            ...
            // NPC_Info
            { "NPC_Info.InvokeUserCode_CmdAnimationPlay__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "NPC_Manager.InvokeUserCode_CmdChangeEmployeeName__Int32__String", new HashSet<CommandPermission> { CommandPermission.General } },
            { "NPC_Manager.InvokeUserCode_CmdChangeEmployeeHat__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "NPC_Manager.InvokeUserCode_CmdChangeEmployeePriority__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "NPC_Manager.InvokeUserCode_CmdChangeAllEmployeePriorities__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            { "NPC_Manager.InvokeUserCode_CmdLoadPrioritiesLayout__Int32[]", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "ProductCheckoutSpawn.InvokeUserCode_CmdAddProductValueToCheckout", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "ProductListing.InvokeUserCode_CmdSetProductOnSale__Int32__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            // StolenProductSpawn
            { "StolenProductSpawn.InvokeUserCode_CmdRecoverStolenProduct", new HashSet<CommandPermission> { CommandPermission.General } },
            ...
            { "UpgradesManager.InvokeUserCode_CmdAddStorage__Int32", new HashSet<CommandPermission> { CommandPermission.General } },
